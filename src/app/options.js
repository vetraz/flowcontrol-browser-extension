...
class Options {
  ...
  bind() {
    ...
    */
    selector('.save-options').click(() => {
      ...
      if (!options.notificationURL || !options.notificationMapperScheme) {
        // Set error message.
  ...
  getOptions() {
    return {
      notificationURL: selector('#notification-server-url').val(),
      notificationMapperScheme: selector('#notification-mapper-scheme').val(),
  ...
  setOptions() {
    storage.get({
      ...
      selector('#notification-server-url').val(data.notificationURL);
      selector('#notification-mapper-scheme').val(data.notificationMapperScheme);
